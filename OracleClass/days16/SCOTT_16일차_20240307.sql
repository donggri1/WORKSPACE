...
-- EXCEPTION
END;
-- 입고수량 = 25 :OLD.입고수량    입고수량 = 30  :NEW.입고수량
...
--------------------------------------------------------------------------------
-- 패키지
--  ㄴ 자주 사용되는 여러 procedure, function들을 하나의 package묶어서 관리에 편리토록 함 
-- DMBS 출력
--DBMS_OUTPUT.PUT();
...
-- [ OPEN ~ FOR문 ]:  동적 쿼리 실행 -> 실행결과물(여러 개의 레코드) + 커서 처리..
