...
SELECT employee_id,last_name||' '||first_name NAME,hire_date,salary,
        CASE 
            WHEN hire_date>TO_DATE('2002-01-01','YYYY-MM-DD')       THEN salary*1.05
            WHEN hire_date>TO_DATE('2002-01-01','YYYY-MM-DD')       THEN salary*1.03
            WHEN hire_date>TO_DATE('2002-01-01','YYYY-MM-DD')       THEN salary*1.01
        ELSE    salary
        END "NEW SALARY"
FROM employees
ORDER BY hire_date ;
