...
public class Ex09 {
	...
	Ex09(int age){//default 생성자
		//this.name = "익명"; 
		this.age = age;
	}
	Ex09(int age,boolean geder){//default 생성자
		//this.name = "익명"; 
		this.age = age;
		this.gender = gender;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println( obj1.name ); //익명 생성자가 나중에 초기화됨
