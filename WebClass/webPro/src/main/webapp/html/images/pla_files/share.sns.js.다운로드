...
/* 텔레그램(Telegram) */
function shareTelegram(strURL, strTitle) {
    if(site_ismobile) location.href="tg://msg_url?url=" + strURL + "&text=" + strTitle;
    else window.open("https://telegram.me/share/url?url=" + strURL + "&text=" + strTitle, "SNSSHARE", "width=800, height=700");
}